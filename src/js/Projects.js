...
import EmailMarketing from '../img/email-dev.png';

export default function Projects() {
  // SVG
  const view = (
    <svg id="icon-eye" height="24px" width="24px" viewBox="0 0 20 20">
      <title>eye</title>
  ...
  const github = (
    <svg id="icon-github" height="24px" width="24px" viewBox="0 0 20 20">
      <title>github</title>
  ...
  const projectData = [
    {
      ...
      view: 'https://email-marketing.netlify.com/',
      github: 'https://github.com/Zackasaurus/email-marketing-dev'
    },
    {
      id: 'mortgage-calculator',
      name: 'Mortgage Calculator',
      image: MortgageCalculator,
      view: 'https://mortgage-calculator.netlify.com/',
      github: 'https://github.com/Zackasaurus/mortgage-calculator'
    },
    {
      id: 'html5-game',
      name: 'HTML 5 Game',
      image: PlatformGame,
      view: 'https://zackasaurus.github.io/shape_running_game/',
      github: 'https://github.com/Zackasaurus/shape_running_game'
    },
    {
      id: 'ez-baccarat-sim',
      name: 'EZ Baccarat Simulator',
      image: EZBaccaratSim,
      view: 'https://zackasaurus.github.io/EZ-BACCARAT-SIMULATOR/',
      github: 'https://github.com/Zackasaurus/EZ-BACCARAT-SIMULATOR'
    },
    {
      id: 'web-design-1',
      name: 'Web Design | UI | UX',
      image: WebDesign1,
      view: 'https://www.behance.net/gallery/63629519/Web-Design-UI-UX',
      github: false
    },
    {
      id: 'web-design-2',
      name: 'Web Design | UI | UX',
      image: WebDesign2,
      view: 'https://www.behance.net/gallery/23938703/Web-Design-UI-UX',
      github: false
    },
    {
      id: 'motion-graphics-1',
      name: 'Motion Graphics',
      image: MotionGraphics1,
      view: 'https://www.behance.net/gallery/37610479/Motion-Graphics',
      github: false
    },
    {
      id: 'motion-graphics-3',
      name: 'Motion Graphics',
      image: MotionGraphics3,
      view: 'https://www.behance.net/gallery/52921001/Motion-Graphics',
      github: false
    },
    {
      id: 'motion-graphics-2',
      name: 'Motion Graphics | Video',
      image: MotionGraphics2,
      view: 'https://www.behance.net/gallery/52921257/Motion-Graphics',
      github: false
    }
  ];
